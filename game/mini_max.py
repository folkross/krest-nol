...
def scores(test):
    # Определение значения очков для различных исходов игры
    scoreDict = {
        'X': 10,
        'Tie': 0,
        '0': -10
...
def mini_max_AI(game_grid, depth, is_maxmizing):
    # Реализация алгоритма mini-max для определения наилучшего хода компьютера
...
def best_move(game_grid):
    # Возвращает лучший ход компьютера
